package com.maxsoft.automation.ios.util.driver;
...
public class DriverSetup extends Base {
    ...
    public static IOSDriver prepareIOSForAppium() throws IOException {
        ...
        capabilities.setCapability("showXcodeLog", Boolean.TRUE);
        capabilities.setCapability("fullReset",Boolean.TRUE);
        ...
        capabilities.setCapability("useNewWDA", Boolean.TRUE);
